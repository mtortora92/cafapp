...
class AddForeignKeysToDocumentoIdentitaTable extends Migration {
	...
	public function up()
	{
		Schema::table('DocumentoIdentita', function(Blueprint $table)
		{
			...
			$table->foreign('rilasciatoDa', 'fk_DocumentoIdentita_Comuni1')->references('id')->on('Comuni')->onUpdate('NO ACTION')->onDelete('NO ACTION');
		});
	}
	...
	public function down()
	{
		Schema::table('DocumentoIdentita', function(Blueprint $table)
		{
			...
			$table->dropForeign('fk_DocumentoIdentita_Comuni1');
		});
	}
